...
public abstract class FileDeleteTools {
	 ...
	 * */
	public abstract boolean DeleteFile(String Path,String FileName,String FileType,Connection connection) 
	 ...
	 * @exception FileOperateException 本地文件操作时抛出的错误，errorcode=0:文件不存在,errorcode=1:不是一个文件,errorcode=2:不能操作，被占用,errorcode=3:不是一个目录
	 * */
	public abstract boolean DeleteFiles(String[] filePaths,Connection connection) 
			throws FileOperateException,IOException;
	 ...
	 * @exception FileOperateException 本地文件操作时抛出的错误，errorcode=0:文件不存在,errorcode=1:不是一个文件,errorcode=2:不能操作，被占用,errorcode=3:不是一个目录
	 * */
	public abstract boolean DeleteRmptyDir(String Path,String DirName,Connection connection) 
			throws FileOperateException,IOException;
