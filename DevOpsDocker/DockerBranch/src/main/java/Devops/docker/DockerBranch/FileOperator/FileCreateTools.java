...
public abstract class FileCreateTools {
	 ...
	 * */
	public abstract boolean createDir(String Path,String DirName,int posixPermissions)
	 ...
	 * @exception FileOperateException 本地文件操作时抛出的错误，errorcode=0:文件不存在,errorcode=1:不是一个文件,errorcode=2:不能操作，被占用,errorcode=3:不是一个目录
	 * */
	public abstract boolean createFile(String Path, String FileName, String FileType)
			throws FileOperateException,RemoteOperateException,IOException;
